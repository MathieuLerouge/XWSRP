# Local libraries
from explaining.explanationpart.explanation import *
from explaining.explorationpart.instance_changes import InstanceChanges
from explaining.explorationpart.instance import EditableInstance
from explaining.explorationpart.solution import EditableSolution
from explaining.history import History
from explaining.questionpart.question import ContrastiveQuestion, CounterfactualQuestion
from explaining.questionpart.questions_templates_bank import *
from explaining.transformationpart.transformation import apply_induced_transformation, apply_induced_transformation_bis
...
class Explainer:
    ...
    def compute_contrastive_explanation(self, question_template_id: str, fields_values: list[str]):
        ...
        contrastive_explanation = create_explanation(contrastive_question, contrastive_support_solution, infeasibility,
