...
from explaining.transformationpart.infeasibility import Infeasibility, TimeInfeasibility
...
from utils.time import convert_nb_minutes_to_time_string, convert_time_string_to_nb_minutes
...
class ExplainerWebGUI:
    ...
    def __init__(self, explainer: Explainer):
        ...
        def _build_explorer_banner():
            ...
            # current_instance_dropdown = html.Div(
            #     id='explorer-banner-container',
            #     #style=dict(display='flex', flex=1, flexdirection='row', alignitems='center', marginRight='10px'),
            #     children=[
            #         html.Div(style=dict(marginRight='10px'), className='label', children="Current instance"),
            #         dcc.Dropdown(
            #             id='current-instance-dropdown', className='dropdown', style=dict(flex=1),
            #             options=[{'label': instance_name, 'value': instance_name}
            #                      for instance_name in self._explainer.instances_names],
            #             value=self.current_instance.name, placeholder="Select current instance", clearable=False
            #         )
