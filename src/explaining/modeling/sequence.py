...
class EditableSequence(SequenceForHeuristics):

    def __init__(self, instance: EditableInstance, employee: EditableEmployee, steps: list[StepForHeuristics] = None):
    ...
    def from_Sequence(cls, sequence: Sequence, instance: EditableInstance = None):
        ...
        steps = [StepForHeuristics(instance.get_hypothetical_activity_by_names(step.activity.name, employee.name),
