...
EXPLANATIONS_TEMPLATES_LIST = [
    ...
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Task} n'est pas réalisé par {Employee} juste après {Activity}"
            the_foil="{Task} is performed by {Employee} just after {Activity}",
            # LANGUAGE_FRENCH_KEY: "{Task} est réalisé par {Employee} juste après {Activity}"
            having_the_foil="having {Task} performed by {Employee} just after {Activity}",
            # LANGUAGE_FRENCH_KEY: "avoir {Task} réalisé par {Employee} juste après {Activity}"
            applying_the_foil_transformation="inserting {Task} just after {Activity} in {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "insérer {Task} juste après {Activity} dans le planning de {Employee}"
        )
    ),
    ExplanationTemplate(
        id=WHY_NOT_INS_2A,
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Task} n'est pas réalisé par {Employee}
    ...
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            the_fact="{Employee} is not performing any other non-performed task "
                     "between two consecutive activities of their planning",
            # LANGUAGE_FRENCH_KEY: "{Employee} ne réalise pas une tâche parmi les non-réalisées
            # entre deux activités consécutives de son planning"
            the_foil="a formerly-non-performed task is performed by {Employee} "
                     "between two consecutive activities of their planning",
            # LANGUAGE_FRENCH_KEY: "une tâche précédemment non-réalisée est réalisé par {Employee}
            # entre deux activités consécutives de son planning"
            having_the_foil="having a formerly-non-performed task performed by {Employee} "
                            "between two consecutive activities of their planning",
            # LANGUAGE_FRENCH_KEY: "avoir une tâche précédemment non-réalisée désormais réalisée par {Employee}
            # entre deux activités consécutives de son planning"
            neighbors="solutions obtained by inserting a non-performed task "
                      "between two consecutive activities of {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en insérant une tâche non-réalisée
            # entre deux activités consécutives du planning de {Employee}"
        )
    ),
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            the_fact="{Task} is not performed by any of the employees "
                     "between two consecutive activities of their planning",
            # LANGUAGE_FRENCH_KEY: "{Task} n'est réalisé par aucun employé
            # entre deux activités consécutives de leur planning"
            the_foil="{Task} is performed by an employee between two consecutive activities of their planning",
            # LANGUAGE_FRENCH_KEY: "{Task} est réalisé par un employé
            # entre deux activités consécutives de son planning"
            having_the_foil="having {Task} performed by an employee "
                            "between two consecutive activities of their planning",
            # LANGUAGE_FRENCH_KEY: "avoir {Task} réalisé par un employé
            # entre deux activités consécutives de son planning"
            neighbors="solutions obtained by inserting {Task} "
    ...
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Task} n'est pas réalisé par {Employee} en plus des activités de son planning"
            the_foil="{Task} is performed by {Employee} in addition to their activities",
            # LANGUAGE_FRENCH_KEY: "{Task} est réalisé par {Employee} en plus des activités de son planning"
            having_the_foil="having {Task} performed by {Employee} in addition to their activities",
            # LANGUAGE_FRENCH_KEY: "avoir {Task} est réalisé par {Employee} en plus des activités de son planning"
            neighbors="solutions obtained by assigning {Task} to {Employee} in addition to their activities"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en affectant {Task} à {Employee}
            # en plus des activités de son planning"
        )
    ),
    ...
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Task1} n'est pas réalisé par {Employee} à la place de {Task2}"
            the_foil="{Task1} is performed by {Employee} in place of {Task2}",
            # LANGUAGE_FRENCH_KEY: "{Task1} est réalisé par {Employee} à la place de {Task2}"
            having_the_foil="{Task1} being performed by {Employee} in place of {Task2}",
            # LANGUAGE_FRENCH_KEY: "avoir {Task1} réalisé par {Employee} à la place de {Task2}"
            applying_the_foil_transformation="replacing {Task2} with {Task1} in {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "remplacer {Task1} par {Task2} dans le planning {Employee}"
        )
    ),
    ExplanationTemplate(
        id=WHY_NOT_SWP_2A,
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Task} n'est pas réalisé par {Employee} à la place d'une tâche de son planning"
            the_foil="{Task} is performed by {Employee} in place of one task of their planning",
            # LANGUAGE_FRENCH_KEY: "{Task} est réalisé par {Employee} à la place d'une tâche de son planning"
            having_the_foil="{Task} being performed by {Employee} in place of one task of their planning",
            # LANGUAGE_FRENCH_KEY: "faire que {Task} soit réalisé par {Employee} à la place d'une tâche de son planning"
            neighbors="solutions obtained by replacing a task in {Employee}'s planning with {Task}"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en remplaçant une tâche
            # dans le planning de {Employee} par {Task}"
        )
    ),
    ExplanationTemplate(
        id=WHY_NOT_SWP_2B,
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Employee} réalise une tâche parmi les non-réalisées
            # à la place d'une tâche de son planning"
            having_the_foil="{Employee} performing a non-performed task in place of one task of their planning",
            # LANGUAGE_FRENCH_KEY: "faire que {Employee} réalise une tâche parmi les non-réalisées
            # à la place d'une tâche de son planning"
            neighbors="solutions obtained by replacing a task in {Employee}'s planning with a non-performed task"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en remplaçant une tâche du planning de {Employee}
    ...
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Task} n'est réalisé par aucun employé à la place d'une tâche de son planning"
            the_foil="{Task} is performed by an employee in place of one of the tasks of their planning",
            # LANGUAGE_FRENCH_KEY: "{Task} est réalisé par un employé à la place d'une tâche de son planning"
            having_the_foil="{Task} being performed by an employee in place of one of the tasks of their planning",
            # LANGUAGE_FRENCH_KEY: "faire que {Task} soit réalisé par un employé à la place d'une tâche de son planning"
            neighbors="solutions obtained by swapping {Task} with one of the tasks performed by an employee"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en remplaçant {Task} par une tâche du planning d'un employé"
        )
    ),
    ExplanationTemplate(
        id=WHY_NOT_SWP_3,
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Task} n'est réalisé par {Employee} à la place d'une tâche de son planning"
    ...
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Employee} ne réalise pas {Task1} plus tard juste après {Task2}"
            applying_the_foil_transformation="moving {Task1} just after {Task2} in {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "déplacer {Task1} juste après {Task2} dans le planning de {Employee}"
        )
    ),
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Employee} ne réalise pas {Task} plus tôt juste avant {Task2}"
            applying_the_foil_transformation="moving {Task1} just before {Task2} in {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "déplacer {Task1} juste avant {Task2} dans le planning de {Employee}"
        )
    ),
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Employee} ne réalise pas {Task} plus tard dans son planning"
            neighbors="solutions obtained by moving {Task} at a later stage in {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en déplaçant {Task} plus tard dans le planning de {Employee}"
        )
    ),
    ExplanationTemplate(
        ...
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Employee} ne réalise pas {Task} plus tôt dans son planning"
            neighbors="solutions obtained by moving {Task} at an earlier stage in {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en déplaçant {Task} plus tôt dans le planning de {Employee}"
        )
    ),
    ExplanationTemplate(
        id=WHY_NOT_ORD_2,
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Employee} ne réalise pas {Task} à un autre moment dans son planning"
            neighbors="solutions obtained by moving {Task} at another stage in {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en déplaçant {Task}
            # à un autre moment dans le planning de {Employee}"
        )
    ),
    ExplanationTemplate(
        id=WHY_NOT_ORD_3,
        typical_expressions=dict(
            ...
            # LANGUAGE_FRENCH_KEY: "{Employee} ne réalise pas les activités de son planning dans un autre ordre"
            neighbors="solutions obtained by permuting the activities in {Employee}'s planning"
            # LANGUAGE_FRENCH_KEY: "solutions obtenues en changeant l'ordre des activités du planning de {Employee}"
        )
    )
]
