...
QUESTIONS_TEMPLATES_LIST = [
    ...
    QuestionTemplate(
        ...
        # LANGUAGE_FRENCH_KEY: "Pourquoi est-ce que l'employé {Employee} ne réalise pas la tâche {Task}
        # en plus des activités déjà réalisées dans son planning (quitte à en changer l'ordre) ?"
        fields_assumptions=[FieldAssumptions(EMPLOYEE), FieldAssumptions(TASK+NOT_PERFORMED_BY_0)]
    ),
    ...
    QuestionTemplate(
        ...
        # à la place d'une tâche de son planning (sans changer l'ordre des activités dans le planning) ?"
        fields_assumptions=[FieldAssumptions(EMPLOYEE)]
    ),
    QuestionTemplate(
        id=WHY_NOT_SWP_2C,
        text="Why is any employee is not performing the task {Task} in place of one of their already-performed tasks?",
    ...
    QuestionTemplate(
        ...
        text="Why is the employee {Employee} not performing the task {Task} "
             ...
             "(even if it means changing their order)?",
        # LANGUAGE_FRENCH_KEY: "Pourquoi est-ce que l'employé {Employee} ne réalise pas une tâche non-réalisée
        # à la place d'une tâche de son planning (quitte à changer l'ordre des activités dans le planning) ?"
        fields_assumptions=[FieldAssumptions(EMPLOYEE), FieldAssumptions(TASK+NOT_PERFORMED_BY_0)]
    ),
    ...
    QuestionTemplate(
        ...
        text="Why is the employee {Employee} not performing the task {Task1} later in their route, "
             "just after the task {Task2}?",
        # LANGUAGE_FRENCH_KEY: "Pourquoi est-ce que l'employé {Employee} ne réalise pas la tâche {Task1}
        # plus tard dans son planning,
        # juste après la tâche {Task2} ?"
    ...
    QuestionTemplate(
        ...
        text="Why is the employee {Employee} not performing the task {Task1} earlier in their route, "
             "just before the task {Task2}?",
        # LANGUAGE_FRENCH_KEY: "Pourquoi est-ce que l'employé {Employee} ne réalise pas la tâche {Task1}
        # plus tôt dans son planning,
        # juste avant la tâche {Task2} ?"
        fields_assumptions=[FieldAssumptions(EMPLOYEE), FieldAssumptions(TASK+PERFORMED_BY_0),
                            FieldAssumptions(TASK+PERFORMED_BY_0)]
        # TODO Add assumption DIFFERENT_FROM_0,1,2
    ),
    ...
    QuestionTemplate(
        id=WHY_NOT_ORD_2,
        text="Why is the employee {Employee} not performing the task {Task} at another position in their route?",
        # LANGUAGE_FRENCH_KEY: "Pourquoi est-ce que l'employé {Employee} ne réalise pas la tâche {Task}
    ...
    QuestionTemplate(
        ...
        # LANGUAGE_FRENCH_KEY: "Pourquoi est-ce que l'employé {Employee} ne réalise pas les activités de son planning
        # dans un autre ordre ?"
        fields_assumptions=[FieldAssumptions(EMPLOYEE)]
    )
]
