...
def teaching_main():
    ...
    :return: None
    """
    if MAIN_PROCESS == RUN_TEACHING_PROCESS:
        if MAIN_PROCESS_AMONG_TEACHING_ONES == RUN_INSTANCE_IP_SOLVING_AS_TEACHING_PROCESS:
            run_IP_optimization_on_teaching_instances(SOLVING_TIME_LIMIT_IN_SECONDS, MUTE_SOLVING_PROCESS)
        elif MAIN_PROCESS_AMONG_TEACHING_ONES == RUN_SOLUTION_FEASIBILITY_CHECK_AS_TEACHING_PROCESS:
