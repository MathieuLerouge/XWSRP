...
#
MAIN_PROCESS = EXPLANATION_PROCESS
# MAIN_PROCESS = EVALUATION_PROCESS
# MAIN_PROCESS = OPTIMIZATION_PROCESS
# MAIN_PROCESS = REOPTIMIZATION_PROCESS
# MAIN_PROCESS = ANALYSIS_PROCESS
# MAIN_PROCESS = TEACHING_PROCESS
...
# by activating one of the following lines
# MAIN_PROCESS_AMONG_EXPLAINER_ONES = EXPLAINER_PROCESS_ON_DEMO_SOLUTION
# MAIN_PROCESS_AMONG_EXPLAINER_ONES = EXPLAINER_PROCESS_ON_SOLUTION_IN_DEFAULT_INPUTS
MAIN_PROCESS_AMONG_EXPLAINER_ONES = EXPLANATIONS_COMPUTATION_ANALYSIS_ON_SOLUTIONS_IN_DEFAULT_INPUTS
...
# by activating one of the following lines
MAIN_PROCESS_AMONG_OPTIMIZATION_ONES = GREEDY_ALGORITHM_PROCESS
# MAIN_PROCESS_AMONG_OPTIMIZATION_ONES = STOCHASTIC_HEURISTIC_PROCESS
# MAIN_PROCESS_AMONG_OPTIMIZATION_ONES = NEIGHBORHOOD_SEARCH_PROCESS
# MAIN_PROCESS_AMONG_OPTIMIZATION_ONES = DETERMINISTIC_GREEDY_ALGORITHM_PROCESS

# Choose which reoptimization process to run when executing __main__.py at the root of the project
# by activating one of the following lines
MAIN_PROCESS_AMONG_REOPTIMIZATION_ONES = NEIGHBORHOOD_SEARCH_PROCESS
...
# by activating one of the following lines
MAIN_PROCESS_AMONG_TEACHING_ONES = TEACHING_SOLUTION_FEASIBILITY_CHECK_PROCESS
# MAIN_PROCESS_AMONG_TEACHING_ONES = TEACHING_INSTANCE_IP_SOLVING_PROCESS
